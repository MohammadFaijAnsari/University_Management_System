    ...
    <form action="lib/fees.php" method="post" id="p1" name="p1">
        <table width="46%" height="370" border="1">
            ...
            <tr>
                ...
                <td><input type="text" name="paid_amount" id="paid_amount" readonly
                        value="<?php if (isset($data2))
                            echo $data2['total_fee'] - $data2['balance'];
                        else
                            echo 0; ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><label>
                        <input type="text" id="amount" name="amount" oninput="setBalance();" maxlength="5"
                            oninput="validate_phone(this,event)" placeholder="0" required/>
                    </label></td>
            </tr>
            <tr>
                <td>Date :- </td>
            ...
            <tr>
                <td>Description :- </td>
                <td>
                    <textarea name="description" id="description" value="<?= $data['description'] ?>" required></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2"><label>
        ...
        <input type="hidden" name="act" value="student_fees" />
